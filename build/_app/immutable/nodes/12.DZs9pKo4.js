import { g as s } from '../chunks/_commonjsHelpers.Cpj98o6Y.js'
import { default as y } from '../chunks/_page.B2P4DdFE.js'
/*!
 * escape-html
...
function l(r) {
	...
	for (e = n.index; e < t.length; e++) {
		...
		a !== e && (i += t.substring(a, e)), (a = e + 1), (i += o)
	}
	return a !== e ? i + t.substring(a, e) : i
}
const u = s(d),
	c = [
		{
...
async function g() {
	return {
		quotes: c.map(({ text: t, ...n }) => ({
			text: u(t).replaceAll(/\*\*(.+?)\*\*/g, '<span style="font-weight: bold">$1</span>'),
			...n
		}))
	}
}
...
export { y as component, p as universal }
